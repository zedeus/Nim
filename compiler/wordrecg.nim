...
type
  TSpecialWord* = enum
    ...
    wImportCpp, wImportPattern, wImportObjC,
    wImportCompilerProc,
    wImportc, wImportSym, wExportc, wExportSym, wExportNims,
    wIncompleteStruct, wRequiresInit,
...
const
  ...
  specialWords*: array[low(TSpecialWord)..high(TSpecialWord), string] = ["",
    ...
    "importcpp", "importPattern", "importobjc",
    "importcompilerproc", "importc", "importSym", "exportc", "exportSym",
    "exportnims", "incompletestruct",
